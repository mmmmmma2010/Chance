...
namespace Give_Pro.Controllers
{
    public class NationalitiesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,NationalitiesName")] Nationalities nationalities)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,NationalitiesName")] Nationalities nationalities)
        {
            if (ModelState.IsValid)
            {
