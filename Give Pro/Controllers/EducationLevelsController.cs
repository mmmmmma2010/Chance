...
namespace Give_Pro.Controllers
{
    public class EducationLevelsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,EducationLevelName")] EducationLevel educationLevel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,EducationLevelName")] EducationLevel educationLevel)
        {
            if (ModelState.IsValid)
            {
