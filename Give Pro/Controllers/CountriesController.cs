...
namespace Give_Pro.Controllers
{
    public class CountriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,CountriesName")] Countries countries)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,CountriesName")] Countries countries)
        {
            if (ModelState.IsValid)
            {
